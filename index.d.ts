...
declare module 'domic-leaflet' {
    export * from 'domic-leaflet/map';
    export * from 'domic-leaflet/grouper';
    import * as L_ from 'leaflet';
    export const L: typeof L_;
}

declare module 'domic-leaflet/map' {
    import { Attrs, Component, MaybeObservable, Verb } from 'domic';
...
declare module 'domic-leaflet/grouper' {
    import { Verb, Observable } from 'domic';
    import * as L from 'leaflet';
